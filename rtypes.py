...
default_history = [
    {'group_label': "Общие",
     'group_data': [{"view": "checkbox", "label": "Нарушение функций щитовидной железы", "value": 0, "name": "1"},
                    {"view": "checkbox", "label": "Сахарный диабет I типа", "value": 0, "name": "2"},
                    {"view": "checkbox", "label": "Сахарный диабет II типа", "value": 0, "name": "3"},
                    {"view": "checkbox", "label": "Хроническая обструктивная болезнь легких", "value": 0, "name": "4"},
                    {"view": "checkbox", "label": "Обструктивное апноэ сна", "value": 0, "name": "5"},
                    {"view": "checkbox", "label": "Хроническая болезнь легких", "value": 0, "name": "6"},
                    {"view": "text", "label": "Рост", "value": 0, "name": "101"},
                    {"view": "text", "label": "Вес", "value": 0, "name": "102"},
                    ]},
    {'group_label': "Вредные привычки и онкология",
     'group_data': [{"view": "checkbox", "label": "Алкоголь", "value": 0, "name": "11"},
                    {"view": "checkbox", "label": "Курение", "value": 0, "name": "12"},
                    {"view": "checkbox", "label": "Употребление наркотиков", "value": 0, "name": "13"},
                    ]},
    {'group_label': "Кардиология",
     'group_data': [{"view": "checkbox", "label": "Артериальная гипертензия", "value": 0, "name": "21"},
                    {"view": "checkbox", "label": "Ишемическая болезнь сердца", "value": 0, "name": "22"},
                    {"view": "checkbox", "label": "Сердечная недостаточность", "value": 0, "name": "23"},
                    {"view": "checkbox", "label": "Поражение клапанного аппарата сердца", "value": 0, "name": "24"},
                    {"view": "checkbox", "label": "Сердечная недостаточность", "value": 0, "name": "25"},
                    {"view": "checkbox", "label": "Кардиомиопатии", "value": 0, "name": "26"},
                    ]},

    {'group_label': "Пороки сердца",
     'group_data': [{"view": "checkbox", "label": "Дефект межпредсердной перегородки", "value": 0, "name": "31"},
                    {"view": "checkbox", "label": "Другие пороки сердца", "value": 0, "name": "32"},
                    ]},
    {'group_label': "Ритм и проводимость",
     'group_data': [{"view": "checkbox", "label": "Нарушения ритма", "value": 0, "name": "41"},
                    {"view": "checkbox", "label": "Нарушение проводимости", "value": 0, "name": "42"},
                    {"view": "checkbox", "label": "Генетическая/наследственная предрасположенность", "value": 0, "name":"43"},
                    ]},
]
